import { IntrCoord, IntrCoordPuttingShip, IntrFullDataShipBattle, IntrWidthShip } from '../../types/Ship.interface';
...
/**
 * Объект со всеми общими функциями караблей
 */
const objFuncShip = {
  getWidthShip,
  transformationToFullCoordShips,
};

export default objFuncShip;
