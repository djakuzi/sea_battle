...
export class StrategyDefault
	implements IntrStandartStrategy<typeof ServiceCreativeStatisticPlayer.strategyName.DEFAULT> {
	readonly name = ServiceCreativeStatisticPlayer.strategyName.DEFAULT;
	...
	async execute(
		...
		if (!res)
			throw new InternalServerErrorException(
				'Произошла ошибка при создании создании зависимостей игрока'
			);
		return res;
	}
}
