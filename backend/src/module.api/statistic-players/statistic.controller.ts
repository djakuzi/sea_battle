...
import { EnumNameStrategyFindStatisticPlayer, ServiceFindStatisticPlayer } from './services/findStatisticPlayer.service';
...
export class StatisticPlayersController {
    constructor(
        private readonly serviceFindPlayerStatistic: ServiceFindStatisticPlayer
    ) { }
    ...
    async getMyStatistic(@Req() req: Request) {
        ...
        return await this.serviceFindPlayerStatistic.find(EnumNameStrategyFindStatisticPlayer.ONE, args);
    }
