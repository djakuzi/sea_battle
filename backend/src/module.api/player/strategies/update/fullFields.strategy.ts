...
// export type TypeReturnStrategyFullFields = ResultUpdateEntity;
...
// @Injectable()
// export class StrategyFullFields implements IntrStandartStrategy<EnumNameStrategyUpdatePlayer> {
